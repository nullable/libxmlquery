...
\section{Profiling memory usage}\label{sec:mprof}
	...
	parser. At this point we can't do anything because the parser has already been optimized and the parsed data doesn't have such an overhead. However, with the flag \emph{USE\_DICT} (see appendix \ref{chap:gcc}) the
	amount of memory usage drops about 6M.
